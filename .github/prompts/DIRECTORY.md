...
| [ux-audit](ux-audit.prompt.md)                       | file or directory | Audit an app's UX, usability, and visual design for Terminal/Console interfaces. |
