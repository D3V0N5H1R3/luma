...
- Types: `boolean`, `integer`, `number`, `string`, `array<T>`, `dictionary<V>`, `queue<T>`, `stack<T>`, `binary_tree`, `channel<T>`, `task<T>`, `optional<T>`, `result<T>`, `socket`, tuples, choice types (ADTs), records, interfaces.
...
- Standard library modules: `String`, `Array`, `Dictionary`, `Math`, `Result`, `Converter`, `DateTime`, `Console`, `FileSystem`, `RegularExpression`, `Process`, `Random`, `Encoder`, `Resource`, `Set`, `Channel`, `Task`, `Terminal`, `GraphicalUi`, `Socket`, `Optional`, `Reference`, `Queue`, `Stack`, `Log`, `Json`, `Csv`, `Xml`, `LinearAlgebra`, `Calculus`, `Hash`, `Compression`, `Http`, `KeyValueStore`, `HashSet`, `LinkedList`, `BinaryTree`, `Graph`.
