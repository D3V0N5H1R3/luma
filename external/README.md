...
on them. Each subdirectory carries its own `README.md` recording provenance and
...
| -------------------------------- | ------------------------------ | ------------------------------ | ---------------------------------- |
| [`mbedtls`](mbedtls/README.md)   | 3.6.6 LTS                      | Apache-2.0 OR GPL-2.0-or-later | `Hash`, `Http`, `Random`           |
| [`miniz`](miniz/README.md)       | 3.1.0                          | MIT                            | `Compression`, `GraphicalUi`       |
| [`webview`](webview/README.md)   | 0.12.0                         | MIT                            | `GraphicalUi` (native window host) |
| [`lit-html`](lit-html/README.md) | 3.2.1                          | BSD-3-Clause                   | `GraphicalUi` (template renderer)  |
| [`lucide`](lucide/README.md)     | 0.473.0                        | ISC                            | `GraphicalUi` (SVG icons)          |
| [`pico-css`](pico-css/README.md) | 2.1.1                          | MIT                            | `GraphicalUi` (base styles)        |
| [`uplot`](uplot/README.md)       | 1.6.31                         | MIT                            | `GraphicalUi` (charts)             |

## First-party code

| Directory                                  | License | Purpose                                                          |
| ------------------------------------------ | ------- | ---------------------------------------------------------------- |
| [`gui-framework`](gui-framework/README.md) | MIT     | Browser-side glue for `GraphicalUi` (renderer, charts, subs, CSS) |
...
- Each third-party subdirectory ships a `README.md` (upstream source URL,
...
- To update a library: replace the files, bump the **Version** and
  **Vendored** date in its `README.md`, regenerate
