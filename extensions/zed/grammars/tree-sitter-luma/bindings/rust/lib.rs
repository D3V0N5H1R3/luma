...
// SAFETY: `tree_sitter_luma` is generated by tree-sitter and returns a valid,
// 'static pointer to the grammar's `TSLanguage`, which is exactly what
// `LanguageFn::from_raw` requires.
...
"#,
    ...
    // extensions/tests/validate-queries.js.  All other queries (folds,
