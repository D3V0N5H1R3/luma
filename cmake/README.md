...
| [LumaDoxygen.cmake](LumaDoxygen.cmake)                 | Defines the `docs` target that generates the API documentation with Doxygen from the configured `Doxyfile`. | [`CMakeLists.txt`](../CMakeLists.txt) |
