...
void register_color_functions(std::vector<FunctionSpec>& specs, const ModuleBuilder& m,
    ...
    append_specs(
        specs,
        {
            m.fn("analogous", 1, "(color: Color)", R::array(named::color()), {named::color()}),
            m.fn("brightness", 1, "(color: Color)", R::number_type(), {named::color()}),
            m.fn("complement", 1, "(color: Color)", named::color(), {named::color()}),
            m.fn("complementary", 1, "(color: Color)", R::array(named::color()), {named::color()}),
            ...
            m.fn("desaturate", 2, "(color: Color, amount: number)", named::color(),
                 {named::color(), p.number}),
            ...
            m.fn("grayscale", 1, "(color: Color)", named::color(), {named::color()}),
            m.fn("invert", 1, "(color: Color)", named::color(), {named::color()}),
            m.fn("is_dark", 1, "(color: Color)", R::boolean_type(), {named::color()}),
            m.fn("is_light", 1, "(color: Color)", R::boolean_type(), {named::color()}),
            m.fn("lighten", 2, "(color: Color.Color, amount: number)", named::color(),
                 {named::color(), p.number}),
            m.fn("luminance", 1, "(color: Color)", R::number_type(), {named::color()}),
            m.fn("mix", 3, "(a: Color.Color, b: Color.Color, t: number)", named::color(),
                 {named::color(), named::color(), p.number}),
            m.fn("readable_text_color", 1, "(background: Color)", named::color(), {named::color()}),
            ...
            m.fn("rotate_hue", 2, "(color: Color.Color, degrees: number)", named::color(),
                 {named::color(), p.number}),
            m.fn("saturate", 2, "(color: Color, amount: number)", named::color(),
                 {named::color(), p.number}),
            ...
            m.fn("triadic", 1, "(color: Color)", R::array(named::color()), {named::color()}),
            m.fn("with_alpha", 2, "(color: Color, alpha: number)", named::color(),
                 {named::color(), p.number}),
        });
}
