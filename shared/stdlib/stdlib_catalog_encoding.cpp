    ...
    append_specs(specs,
                 {
                     ...
                     m.fn("digest_file", 2, "(algorithm: Hash.Algorithm | string, path: string)",
                     ...
                     m.fn("md5_file", 1, "(path: string)", R::result_string(), {p.string}),
                     m.fn("md5_typed", 1, "(value: string)", named::digest(), {p.string}),
                     m.fn("sha1", 1, "(value: string)", R::string_type(), {p.string}),
                     m.fn("sha1_file", 1, "(path: string)", R::result_string(), {p.string}),
