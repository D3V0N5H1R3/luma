...
std::vector<std::pair<std::string, std::string>> get_type_keywords() {
    return {
        {"boolean", "primitive type"},      {"integer", "primitive type"},
        {"number", "primitive type"},       {"decimal", "exact base-10 number"},
        {"string", "primitive type"},       {"void", "return type"},
        {"array", "generic container"},     {"dictionary", "generic container"},
        {"optional", "generic wrapper"},    {"result", "generic wrapper"},
        {"channel", "concurrency"},         {"task", "concurrency"},
        {"reference", "generic wrapper"},   {"set", "ordered collection"},
        {"stack", "LIFO collection"},       {"queue", "FIFO collection"},
        {"binary_tree", "tree collection"}, {"key_value_store", "persistent store"},
        {"socket", "network I/O"},          {"widget", "graphical UI"},
        {"xml", "structured data"},
    };
}
