...
- The project spans ~150K+ lines across interpreter core, 38 stdlib module namespaces (27 always-available + 4 sandbox-aware + 7 OS-only), an LSP language server (`luma_lsp`), a DAP debugger (`luma_dap`), and editor extensions for VS Code and Zed.
