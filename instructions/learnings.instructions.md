...
- The project spans ~150K+ lines across interpreter core, 39 stdlib module namespaces (28 always-available + 3 sandbox-aware + 8 OS-only), an LSP language server (`luma_lsp`), a DAP debugger (`luma_dap`), and editor extensions for VS Code and Zed.
