...
You should see a version number, such as `Luma 0.8.0`. If you do, you are ready.
...
A **string** is a piece of text, written between double quotes: `"hello"`, `"Luma 0.8"`, `""` (the empty string). Strings hold names, messages, file contents — anything textual.
