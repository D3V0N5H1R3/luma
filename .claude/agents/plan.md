...
[copilot-instructions.md](../../.github/copilot-instructions.md). Plans trace changes across the pipeline split:
...
2. **Structure the plan:** Use the [plan template](../../.github/plan-template.md) to organise your output.
...
7. **Pause for review:** Present the plan and wait for feedback before handing off. Once approved, the [implement](implement.md) agent executes the plan task by task.

## Commands

Build and test with the CMake presets in the **Build and Test** section of
[copilot-instructions.md](../../.github/copilot-instructions.md). The verification
